...
function GrandRoom() {
    ...
    const details = `Indulge in elegance and relaxation, as you enjoy an
                        ...
                        <div className="service-item text-center pt-3">
                            <div className="p-4">
                                ...
                                <img
                                    ...
                                    src="assets/img/resort/Grand Deluxe  Room/DSCF9711.jpg"
                                    alt=""
                    ...
                    <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div className="service-item text-center pt-3">
                            <div className="p-4">
                                ...
                                <img
                                    className="img-fluid w-100 h-100 mb-4"
                                    src="assets/img/resort/Grand Deluxe  Room/DSCF9714 (1).jpg"
                                    alt=""
                                    style={{ objectFit: "cover" }}
                                />
                                {/* ใส่รูป */}
                    ...
                    <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div className="service-item text-center pt-3">
                            <div className="p-4">
                                ...
                                <img
                                    className="img-fluid w-100 h-100 mb-4"
                                    src="assets/img/resort/Grand Deluxe  Room/DSCF9717 (1).jpg"
                                    alt=""
                                    style={{ objectFit: "cover" }}
                                />
                                {/* ใส่รูป */}
                    ...
                    <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div className="service-item text-center pt-3">
                            <div className="p-4">
                                ...
                                <img
                                    className="img-fluid w-100 h-100 mb-4"
                                    src="assets/img/resort/Grand Deluxe  Room/DSCF9734.jpg"
                                    alt=""
                                    style={{ objectFit: "cover" }}
                                />
                                {/* ใส่รูป */}
                    ...
                    <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div className="service-item text-center pt-3">
                            <div className="p-4">
                                ...
                                <img
                                    className="img-fluid w-100 h-100 mb-4"
                                    src="assets/img/resort/Grand Deluxe  Room/DSCF9736.jpg"
                                    alt=""
                                    style={{ objectFit: "cover" }}
                                />
                                {/* ใส่รูป */}
                    ...
                    <div className="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div className="service-item text-center pt-3">
                            <div className="p-4">
                                ...
                                <img
                                    className="img-fluid w-100 h-100 mb-4"
                                    src="assets/img/resort/Grand Deluxe  Room/DSCF9753.jpg"
                                    alt=""
                                    style={{ objectFit: "cover" }}
                                />
                                {/* ใส่รูป */}
